...
?>
    ...
    <nav class="tab_nav">
        ...
        ?>
                <button class="tab_nav-button" type="button" data-tab_nav-button-number="<?= $i ?>" onclick="<?= $callbackArray[0] ?>;<?= $callbackArray[1] ?>">
    ...
    <script src="./js/components/toggle_log_reg.js"></script>
